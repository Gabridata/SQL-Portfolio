...
(case_id, case_number, participant_id, participant_name, participant_type, case_role)
...
| Name formatting   | Standardize compound names and accents         | String manipulation        |
| Advanced cleansing| Handle complex name formats and validation     | Python libraries           |
| Entity resolution | Detect potentially duplicated identities       | Python (FuzzyWuzzy)        |
